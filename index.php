    ...
    <div class="alert alert-info alert-dismissible fade show mb-0 rounded-0 d-lg-flex d-none py-2 align-items-center"
        ...
        <div class="row w-100 align-items-center">
            <div class="col-6">
                ...
                <strong>جشنواره فروش</strong> سربرگ چاپ اینجا شروع شد ، بدو تا جا نموندی
            </div>
            <div class="col-6 text-end">
                <a href="" class="btn btn-warning rounded-pill waves-effect waves-light">مشاهده و خرید <svg
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="main-category-title">
                    <h4 class="main-title">دسته بندی های محصولات</h4>
                </div>
