...
$discountList = $fee->Addtanavoproduct($product_id,$name,$javab1,$javab2,$javab3,$javab4,$fori,$no_fori,$yero,$doro,$fori_yero_price,$fori_doro_price,$no_fori_yero_price,$no_fori_doro_price,$deliver_time_fori,$deliver_time_no_fori);
			if($discountList==1){echo'با موفقیت اضافه شد';}
		}
	...
	<div class="input-group">
	<input type="text" name="fori" id="fori" class="form-control" value="" ></div>
	...
	<div class="input-group">
	<input type="text" name="no_fori" id="no_fori" class="form-control" value="" ></div>
	...
	<div class="input-group">
	<input type="text" name="yero" id="yero" class="form-control" value="" ></div>
	...
	<div class="input-group">
	<input type="text" name="doro" id="doro" class="form-control" value="" ></div>
	...
	<div class="input-group">
	<input type="text" name="fori_yero_price" id="fori_yero_price" class="form-control" value="" ></div>
	...
	<div class="input-group">
	<input type="text" name="fori_doro_price" id="fori_doro_price" class="form-control" value="" ></div>
	...
	<div class="input-group">
	<input type="text" name="no_fori_yero_price" id="no_fori_yero_price" class="form-control" value="" ></div>
	...
	<div class="input-group">
	<input type="text" name="no_fori_doro_price" id="no_fori_doro_price" class="form-control" value="" ></div>
	...
	<div class="input-group">
	<input type="text" name="deliver_time_fori" id="deliver_time_fori" class="form-control" value="" ></div>
	...
	<div class="input-group">
	<input type="text" name="deliver_time_no_fori" id="deliver_time_no_fori" class="form-control" value="" ></div>
