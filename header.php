                ...
                <div class="col-lg-12 col-4 order-lg-4 order-1 ">
                    <div class="top-menu-menu d-lg-flex d-none">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item"><a href="" class="nav-link border-animate fromCenter">درباره ما</a>
							  <li class="nav-item"><a href="" class="nav-link border-animate fromCenter">ارتباط با ما</a>
